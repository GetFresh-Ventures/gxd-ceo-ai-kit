...
1. **Browse by category** to find skills for your current task
2. **Check the trigger phrases** — skills auto-activate on keywords in your request
3. **Skills compose** — combine `meeting-prep` + `post-meeting-brief` for the full meeting lifecycle
4. **Cross-references** — each skill lists related skills at the bottom

## Quick Reference

| Need | Skill | Trigger Phrase |
|------|-------|---------------|
| Strategic advice | `ceo-advisor`, `cfo-advisor`, `cmo-advisor` | "what should I do about..." |
| Pipeline check | `pipeline-pulse` | "what's closing?" |
| Process meeting notes | `post-meeting-brief` | "process my notes" |
| Write an email | `email-composer` | "draft an email to..." |
| Build a pitch deck | `fundraise` | "investor deck" |
...
Skills are most powerful when composed:
...
2. **Source of truth or bust** — Always ground in live systems, never memory alone
3. **One variable per experiment** — From `experiment-loop`, but applies everywhere
...
|--------|-------------------|
| GFV Original | 37 skills (chief-of-staff v1, all C-suite, deal-review, etc.) |
| [anthropics/skills](https://github.com/anthropics/skills) | spreadsheet-builder, pdf-toolkit, doc-builder, doc-coauthoring |
| [marketingskills](https://github.com/coreyhaines31/marketingskills) | sales-enablement, content-strategy, conversion-optimizer |
| [everything-claude-code](https://github.com/anthropics/everything-claude-code) | fundraise (merged investor-materials + investor-outreach) |
